...
const Paths = {
  ...
  JS: {
    ...
    THEME: [
      ...
      'js/theme/**/!(Utils | bootstrap-navbar | bootstrap-select-menu | detector | forms | stickyfill | stickykit | tooltip | navbar | emojionearea)*.js',
    ],
  ...
  DEPENDENCIES: {
    ...
    'smooth-scrollbar': {
      FROM: ['node_modules/smooth-scrollbar/dist/smooth-scrollbar.js'],
      TO: lib,
    },
    'emojionearea': {
