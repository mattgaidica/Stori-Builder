...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { content: @entity.content, has_type: @entity.has_type } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { content: @entity.content, has_type: @entity.has_type } }
