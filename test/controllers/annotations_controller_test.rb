...
class AnnotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create annotation" do
    assert_difference('Annotation.count') do
      post annotations_url, params: { annotation: { body: @annotation.body, source_id: @annotation.source_id } }
    end
  ...
  test "should update annotation" do
    patch annotation_url(@annotation), params: { annotation: { body: @annotation.body, source_id: @annotation.source_id } }
