...
class StacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stack" do
    assert_difference('Stack.count') do
      post stacks_url, params: { stack: { name: @stack.name, pref_annotations_showsource: @stack.pref_annotations_showsource, pref_settings_importpath: @stack.pref_settings_importpath } }
    end
  ...
  test "should update stack" do
    patch stack_url(@stack), params: { stack: { name: @stack.name, pref_annotations_showsource: @stack.pref_annotations_showsource, pref_settings_importpath: @stack.pref_settings_importpath } }
